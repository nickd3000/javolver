package com.physmo.reference.oldexamples;
...
/*
 * com.physmo.reference.GeneWord - A very simple example where the goal is to match the output to
 * a supplied string.
...
public class WordFindMetaSolver {
    ...
    public static void main(String[] args) {
        ...
        for (int j = 0; j < 500; j++) {
            ...
            //com.physmo.reference.GeneWord gene = (com.physmo.reference.GeneWord)javolver.findBestScoringIndividual(javolver.getPool());
