package com.physmo.reference.oldexamples.picturesolver;
...
import com.physmo.reference.TestLinePic;
...
public class PictureSolver {
    ...
    public static com.physmo.reference.picturesolver.GenePicSolver GetRandomIndividual(List<com.physmo.reference.picturesolver.GenePicSolver> bestIndividuals) {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        com.physmo.reference.picturesolver.GenePicSolver gps = new com.physmo.reference.picturesolver.GenePicSolver(targetImage, drawerClass, numberOfDrawingElements, scoreStep);
        ...
        for (int j = 0; j < 3000000; j++) {
            ...
            if (j % 20 == 0) {
                ...
                com.physmo.reference.picturesolver.GenePicSolver top = (com.physmo.reference.picturesolver.GenePicSolver) javolver.findBestScoringIndividual();
