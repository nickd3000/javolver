package com.physmo.reference.oldexamples.programming;

import com.physmo.javolver.Chromosome;
import com.physmo.reference.programming.ProgramEvaluator;
import com.physmo.reference.programming.SimpleMachine;
...
public class WordEvaluator implements ProgramEvaluator {
    ...
    @Override
    public double evaluate(com.physmo.reference.programming.SimpleMachine sm, Chromosome dna, double step) {
...
//        score-=scorePenalty;
    ...
    @Override
    public void preEvaluateStep(com.physmo.reference.programming.SimpleMachine sm, Chromosome dna, double step) {
